...
$dynamic("set$selected").HTMLOptionElement = function(value) { return this.selected = value; };
...
OptionElementWrappingImplementation.prototype.set$selected = function(value) {
  this._ptr.set$selected(value);
}
...
WebGLRenderingContextWrappingImplementation.prototype.uniform1fv = function(location, v) {
  this._ptr.uniform1fv(LevelDom.unwrap(location), LevelDom.unwrap(v));
  return;
}
...
WebGLRenderingContextWrappingImplementation.prototype.viewport = function(x, y, width, height) {
  this._ptr.viewport(x, y, width, height);
  return;
}
...
//  ********** Library webgl2dImageProcessing **************
// ********** Code for webgl2dImageProcessing **************
function webgl2dImageProcessing() {
  this.neffects = new Array();
}
webgl2dImageProcessing.prototype.run = function() {
  var image = html_get$document().query("#photo");
  this.render(image);
  this.write("");
}
webgl2dImageProcessing.prototype.render = function(image) {
  var $this = this; // closure support
  ...
  var texCoordBuffer = gl.createBuffer$0();
  gl.bindBuffer((34962), texCoordBuffer);
  var vertices = [(0), (0), (1), (0), (0), (1), (0), (1), (1), (0), (1), (1)];
  gl.bufferData((34962), Float32ArrayWrappingImplementation.Float32ArrayWrappingImplementation$from$factory(vertices), (35044));
  gl.enableVertexAttribArray(texCoordLocation);
  gl.vertexAttribPointer(texCoordLocation, (2), (5126), false, (0), (0));
  ...
  gl.texImage2D$6((3553), (0), (6408), (6408), (5121), image);
  var textures = [];
  var framebuffers = [];
  for (var i = (0);
   $lt(i, (2)); (i = $add(i, (1)))) {
    ...
    gl.texImage2D((3553), (0), (6408), image.get$width(), image.get$height(), (0), (6408), (5121));
    var fbo = gl.createFramebuffer();
    framebuffers.add$1(fbo);
  ...
  gl.uniform2f(textureSizeLocation, image.get$width(), image.get$height());
  var kernels = _map(["normal", [(0), (0), (0), (0), (1), (0), (0), (0), (0)], "gaussianBlur", [(0.045), (0.122), (0.045), (0.122), (0.332), (0.122), (0.045), (0.122), (0.045)], "gaussianBlur2", [(1), (2), (1), (2), (4), (2), (1), (2), (1)], "gaussianBlur3", [(0), (1), (0), (1), (1), (1), (0), (1), (0)], "unsharpen", [(-1), (-1), (-1), (-1), (9), (-1), (-1), (-1), (-1)], "sharpness", [(0), (-1), (0), (-1), (5), (-1), (0), (-1), (0)], "sharpen", [(-1), (-1), (-1), (-1), (16), (-1), (-1), (-1), (-1)], "edgeDetect", [(-0.125), (-0.125), (-0.125), (-0.125), (1), (-0.125), (-0.125), (-0.125), (-0.125)], "edgeDetect2", [(-1), (-1), (-1), (-1), (8), (-1), (-1), (-1), (-1)], "edgeDetect3", [(-5), (0), (0), (0), (0), (0), (0), (0), (5)], "edgeDetect4", [(-1), (-1), (-1), (0), (0), (0), (1), (1), (1)], "edgeDetect5", [(-1), (-1), (-1), (2), (2), (2), (-1), (-1), (-1)], "edgeDetect6", [(-5), (-5), (-5), (-5), (39), (-5), (-5), (-5), (-5)], "sobelHorizontal", [(1), (2), (1), (0), (0), (0), (-1), (-2), (-1)], "sobelVertical", [(1), (0), (-1), (2), (0), (-2), (1), (0), (-1)], "previtHorizontal", [(1), (1), (1), (0), (0), (0), (-1), (-1), (-1)], "previtVertical", [(1), (0), (-1), (1), (0), (-1), (1), (0), (-1)], "boxBlur", [(0.111), (0.111), (0.111), (0.111), (0.111), (0.111), (0.111), (0.111), (0.111)], "triangleBlur", [(0.0625), (0.125), (0.0625), (0.125), (0.25), (0.125), (0.0625), (0.125), (0.0625)], "emboss", [(-2), (-1), (0), (-1), (1), (1), (0), (1), (2)]]);
  var positionBuffer = gl.createBuffer$0();
  gl.bindBuffer((34962), positionBuffer);
  gl.enableVertexAttribArray(positionLocation);
  gl.vertexAttribPointer(positionLocation, (2), (5126), false, (0), (0));
  setRectangle(gl, (0), (0), image.get$width(), image.get$height());
  var effects = [_map(["name", "normal", "on", true]), _map(["name", "gaussianBlur3", "on", false]), _map(["name", "gaussianBlur3", "on", false]), _map(["name", "gaussianBlur3", "on", false]), _map(["name", "sharpness", "on", false]), _map(["name", "sharpness", "on", false]), _map(["name", "sharpness", "on", false]), _map(["name", "sharpen", "on", false]), _map(["name", "sharpen", "on", false]), _map(["name", "sharpen", "on", false]), _map(["name", "unsharpen", "on", false]), _map(["name", "unsharpen", "on", false]), _map(["name", "unsharpen", "on", false]), _map(["name", "emboss", "on", false]), _map(["name", "edgeDetect", "on", false]), _map(["name", "edgeDetect", "on", false]), _map(["name", "edgeDetect3", "on", false]), _map(["name", "edgeDetect3", "on", false])];
  var ui = html_get$document().query("#ui");
  var table = ElementWrappingImplementation.ElementWrappingImplementation$tag$factory("table");
  var tbody = ElementWrappingImplementation.ElementWrappingImplementation$tag$factory("tbody");
  function setFramebuffer(l_fbo, l_width, l_height) {
    gl.bindFramebuffer((36160), l_fbo);
    gl.uniform2f(resolutionLocation, l_width, l_height);
    gl.viewport$4((0), (0), l_width, l_height);
  }
  ;
  function drawWithKernel(name) {
    gl.uniform1fv(kernelLocation, Float32ArrayWrappingImplementation.Float32ArrayWrappingImplementation$from$factory(kernels.$index(name)));
    gl.drawArrays((4), (0), (6));
  }
  ;
  function drawEffects() {
    gl.bindTexture((3553), originalImageTexture);
    gl.uniform1f(flipYLocation, (1));
    var count = (0);
    $this.neffects.forEach$1((function (effect) {
      setFramebuffer(framebuffers.$index($mod(count, (2))), image.get$width(), image.get$height());
      drawWithKernel(effect);
      gl.bindTexture((3553), textures.$index($mod(count, (2))));
      (count = $add(count, (1)));
    })
    );
    gl.uniform1f(flipYLocation, (-1));
    setFramebuffer(null, canvas.get$width(), canvas.get$height());
    drawWithKernel("normal");
  }
  ;
  var selects = new Array();
  for (var i = (0);
   $lt(i, effects.get$length()); (i = $add(i, (1)))) {
    var select = ElementWrappingImplementation.ElementWrappingImplementation$tag$factory("select");
    selects.add(select);
    for (var j = (0);
     $lt(j, effects.get$length()); j = $add(j, (1))) {
      effects.forEach$1((function (select, effect) {
        var option = ElementWrappingImplementation.ElementWrappingImplementation$tag$factory("option");
        option.set$value(effect.$index("name"));
        if ($eq(effect.$index("name"), "normal")) {
          option.set$selected(true);
        }
        option.set$text(effect.$index("name"));
        select.get$nodes().add(option);
      }).bind(null, select)
      );
    }
  }
  selects.forEach$1((function (s) {
    ui.get$nodes().add(s);
    s.get$on().get$change().add((function (event) {
      $this.neffects.clear();
      var ncount = (0);
      selects.forEach$1((function (select) {
        if (!($eq(select.$index("name"), "normal") && ncount != (0))) {
          $this.neffects.add(select.get$value());
        }
        if ($eq(select.$index("name"), "normal") && ncount == (0)) {
          ncount++;
        }
...
webgl2dImageProcessing.prototype.write = function(message) {
  html_get$document().query("#status").set$innerHTML(message);
}
// ********** Code for top level **************
function main() {
  new webgl2dImageProcessing().run();
}
// 168 dynamic types.
// 494 types
// 43 !leaf
...
(function(){
  ...
  var v7/*Node*/ = [v3/*CharacterData*/,v4/*Document*/,v5/*Element*/,'Node|Attr|DocumentFragment|DocumentType|Entity|EntityReference|Notation|ProcessingInstruction'].join('|');
  var v8/*Uint8Array*/ = 'Uint8Array|Uint8ClampedArray';
  var v9/*AudioParam*/ = 'AudioParam|AudioGain';
  var v10/*Blob*/ = 'Blob|File';
  var v11/*CSSRule*/ = 'CSSRule|CSSCharsetRule|CSSFontFaceRule|CSSImportRule|CSSMediaRule|CSSPageRule|CSSStyleRule|CSSUnknownRule|WebKitCSSKeyframeRule|WebKitCSSKeyframesRule|WebKitCSSRegionRule';
  var v12/*CSSValueList*/ = 'CSSValueList|WebKitCSSTransformValue';
  var v13/*DOMTokenList*/ = 'DOMTokenList|DOMSettableTokenList';
  ...
  var table = [
    ...
    , ['Blob', v10/*Blob*/]
    , ['CSSRule', v11/*CSSRule*/]
    , ['CSSValueList', v12/*CSSValueList*/]
    , ['CharacterData', v3/*CharacterData*/]
    , ['DOMTokenList', v13/*DOMTokenList*/]
