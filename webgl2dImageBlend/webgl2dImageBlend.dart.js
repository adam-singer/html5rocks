...
//  ********** Library webgl2dImageBlend **************
// ********** Code for webgl2dImageBlend **************
function webgl2dImageBlend() {

}
webgl2dImageBlend.prototype.run = function() {
  var image = html_get$document().query("#photo");
  this.render(image);
  this.write("");
}
webgl2dImageBlend.prototype.render = function(image) {
...
webgl2dImageBlend.prototype.write = function(message) {
