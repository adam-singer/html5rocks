...
//  ********** Library webgl2dImage **************
// ********** Code for webgl2dImage **************
function webgl2dImage() {

}
webgl2dImage.prototype.run = function() {
  var image = html_get$document().query("#photo");
  this.render(image);
  this.write("");
}
webgl2dImage.prototype.render = function(image) {
...
webgl2dImage.prototype.write = function(message) {
