...
//  ********** Library webgl2dImage3x3Convolution **************
// ********** Code for webgl2dImage3x3Convolution **************
function webgl2dImage3x3Convolution() {

}
webgl2dImage3x3Convolution.prototype.run = function() {
  var image = html_get$document().query("#photo");
  this.render(image);
  this.write("");
}
webgl2dImage3x3Convolution.prototype.render = function(image) {
  ...
  select.get$on().get$change().add((function (event) {
    debugPrint(event);
    debugPrint(event.get$type());
    debugPrint(select.get$value());
    drawWithKernel(select.get$value());
  })
  , false);
  ui.get$nodes().add(select);
...
webgl2dImage3x3Convolution.prototype.write = function(message) {
